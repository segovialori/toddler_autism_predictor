...
#variables for explore functions

# categorical and quantitative variables
cat_vars = ['name_response', 'eye_contact', 'pointing', 'shared_interest',
       'pretend_play', 'joint_attention', 'emotions', 'vocal', 'gestures',
       'blank_gaze','ethnicity', 'jaundice', 'family_mem_with_asd','asd_traits', 'sex_m']
